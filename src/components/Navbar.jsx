...
const Navbar = () => {
  ...
  const navLinkClass = ({ isActive }) =>
    `relative after:content-[''] after:absolute after:left-0 after:-bottom-2 after:h-[2px] after:bg-amber-300 after:transition-all after:duration-300 ${
      isActive ? "after:w-full text-amber-300" : "after:w-0 hover:after:w-full"
    }`;
    ...
    <header className="w-full sticky top-0 z-50 bg-[var(--primary-color)]/95 backdrop-blur-md text-white">
      ...
      <div
        className={`lg:hidden absolute top-full left-0 w-full bg-[var(--primary-color)] overflow-hidden transition-all duration-300 z-50 ${
          mobileMenu ? "max-h-100 border-t border-white/10" : "max-h-0"
        }`}
      >
        <div className="primary-container py-6">
          <ul className="flex flex-col gap-6 text-lg font-medium">
            ...
            <li>
              <NavLink to="/rent" onClick={() => setMobileMenu(false)}>
                Rent
              </NavLink>
            </li>
            ...
            <li>
              <NavLink to="/resources" onClick={() => setMobileMenu(false)}>
                Resources
              </NavLink>
            </li>
          </ul>
